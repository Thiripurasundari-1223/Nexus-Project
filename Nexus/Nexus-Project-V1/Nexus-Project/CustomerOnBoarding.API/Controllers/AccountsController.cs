...
namespace CustomerOnBoarding.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        #region Get all Customer Contact Details 
        [HttpGet]
        [Route("GetAllCustomerContactDetails")]
        public IActionResult GetAllCustomerContactDetails()
        {
            try
            {
                return Ok(new
                {
                    StatusCode = "SUCCESS",
                    StatusText = string.Empty,
                    Data = _cobServices.GetAllCustomerContactDetails()
                });
            }
            catch (Exception ex)
            {
                LoggerManager.LoggingErrorTrack(ex, "Accounts", "Accounts/GetAllCustomerContactDetails", _cobServices.GetAllCustomerContactDetails().ToString());
                return Ok(new
                {
                    StatusCode = "FAILURE",
                    StatusText = ex.ToString(),
